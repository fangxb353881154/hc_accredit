...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/sys/authorKey/list">授权码列表</a></li>
		<shiro:hasPermission name="sys:authorKey:edit"><li><a href="${ctx}/sys/authorKey/form">授权码添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="authorKey" action="${ctx}/sys/authorKey/list" method="post" class="breadcrumb form-search">
